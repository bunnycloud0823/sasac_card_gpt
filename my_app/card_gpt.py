...
from card_rag import search_card # card_rag 다 쓰고 추가
...
user_prompt = """\
아래의 사용자 question을 읽고 context를 참고하여 가장 적합한 카드(사용자가 혜택을 최대로 받을 수 잇는 카드)를 추천해주세요.
...
# 2. 사용자 질의 작성
question = st.chat_input("사용자 입력") # 입력창 생성
